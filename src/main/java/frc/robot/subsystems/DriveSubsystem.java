...
public class DriveSubsystem extends SubsystemBase {
  ...
  public DriveSubsystem() {
    ...
    // PathPlanner AutoBuilder Configuration - MUST be inside the constructor
    try {
  ...
  /** Returns the current robot-relative speeds. Used by PathPlanner. */
  ...
  /** Drive the robot using robot-relative speeds. Used by PathPlanner. */
