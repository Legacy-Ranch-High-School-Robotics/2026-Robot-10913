...
/**
 * The coordinator master class for Simulation.
 * Ensures the strict execution order:
 * 1) DriveSim.update() 
 * 2) VisionSim.update(DriveSim.getActualPose()) 
 * 3) Publish Actual Pose to SmartDashboard/AdvantageScope
 */
